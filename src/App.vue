<template>
  <div class="header">
    ...
    <Container :게시물 = "게시물" :step="step" :thisFilter="thisFilter" :uploadimg="uploadimg" v-model="parentContent" @contentTxt ="txtCont = $event" :filterData="filterData"/>
